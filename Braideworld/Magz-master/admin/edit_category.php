                        ...
                        <ul class="list-unstyled topbar-menu float-end mb-0">
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                                    ...
                                    <span>
                                        <span class="account-user-name"><?phpecho $user_obj->getusername(); ?></span>
                     ...
                     if(isset($_POST['u_add_cat'])){
                        ...
                        ?>
                                                 ...
                                                 <div class="mb-3">
                                                          ...
                                                          <h1 class="text-dark font-15 text-bold">Update Category</h1>
                                                        </div>
                                                        <div class="mb-3"> 
                                                        
                                                            <input type="text" class="form-control" data-provide="typeahead" id="the-basics" placeholder="Add Category" name="u_cat_title" value="<?php echo $cat_title; ?>">
                                                           <center> <br>
                                                           <input type="submit" name="u_add_cat" class="btn btn-success btn-sm mb-5 align-items-center" value="Update Category">
                                                           </center>
                                                        </div>
                                                    </div> 

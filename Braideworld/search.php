<?php include 'extension/header.php'; ?>
		<section class="category">
		  <div class="container">
		    <div class="">
		      <div class="col-md-8 text-left">
                ...
                if(isset($_GET['q']) && $_GET['q'] !== ""){
                    $q = $_GET['q'];
                    echo "<p class='page-subtitle mb-5'><h4 class='text-danger'>Showing result for &nbsp;$q </h4> 
             </p>";
                }else{
		        ...
		        <div class='row'>";
                $query = mysqli_query($connection, "SELECT * FROM news  WHERE content LIKE '%$q%' OR tags LIKE '%$q%' OR added_by LIKE '%$q%' OR id LIKE '%$q%' OR type LIKE '%$q%' OR title LIKE '%$q%'  ORDER BY id DESC LIMIT $page_1, $per_page");
                $str = "";
            ...
            $str .= "<article class='col-md-12 article-list bg-white box-shadow padding-0'>
            <div class='inner'>
              <figure>
						   ...
						   for($i=1; $i <= $count; $i++){
							if($i == $page){
							 ...
							 elseif($i != $page){
									...
									echo "<li class='active small'><a href='search.php?q=$q&&page={$i}'>{$i}</a></li>
									";
							  }
							}
					?>
		            ...
		            <article class="article-fw bg-white box-shadow padding-0">
		              <div class="inner">
		                ...
		                <div class="details padding" style='padding:15px;'>
		                  <h1><a href="singlepost.php?post_id=<?php echo$id?>&cat_r=<?php echo $category ?>"><?php echo $title ?></a></h1>
		                  <p>
		                    <?php echo $content ?>
		                  </p>
		                  <div class="detail">

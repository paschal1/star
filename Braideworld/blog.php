...
<head>
  ...
  <title>dStarite Blog - Index</title>
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html"><span>d</span>Starite Blog</a></h1>
  ...
  <main id="main">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="slider-content text-center">
              <div class="header-bottom">
                ...
                <div class="layer3">
                  <h2 class="title3">dStarite Profesional Blog Page</h2>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="blog-page area-padding">
							...
							<div class="col-md-12 col-sm-12 hidden-lg hidden-md" >
								...
								<h5 class="title-col" style="margin-bottom:5px;">
									Top News

<?php include 'extension/header.php'; ?>
		...
		<section class="home">
			<div class="container">
				<marquee behavior="" direction="left" scrollamount="10" class="col-lg-12">Welcome to <span style="color:white; background-color:black;"><strong>D-Starite </strong></span><span style="color:green;"><strong>Technology</strong></span> <span>So much more to read now 
				...
				<div class="row">
					...
					<div class="headline">
							...
							<div class="owl-carousel owl-theme" id="headline">							
								<div class="item">
									<a href="#"><div class="badge">Breaking</div> all we have for you are good news</a>
								</div>
								<div class="item">
									<a href="#">Your Spot for Digital solutions</a>
								</div>
							</div>
						</div>
...
<!-- ======================================== Small and midi screen sidepost -->
                        ...
                        <!-- <aside id="sponsored" class='hidden-lg hidden-md'>
							<h1 class="aside-title">dStarite's Forum</h1>

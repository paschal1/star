                        ...
                        <ul class="list-unstyled topbar-menu float-end mb-0">
                            <li class="dropdown notification-list d-lg-none">
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg p-0">
                                    <form class="p-3" method= "POST" action='searchpost.php'>
                                        <input type="submit" class="form-control" placeholder="Search ..." aria-label="Recipient's username" name="s">
                                    </form>
                                </div>
                            </li>
                        ...
                        <div class="app-search dropdown d-none d-lg-block">
                            <form method= "GET" action="search.php" >
                                <div class="input-group">
                                    ...
                                    <input class="input-group-text btn-primary" type="submit" name="s">
                                </div>
                            </form>
                        </div>
                    </div>
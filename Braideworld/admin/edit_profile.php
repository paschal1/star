                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="typeahead-preview">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                  <center>  <img src="<?php echo $user_obj->getprofilepic();?>" alt=""  class="rounded-circle avatar-lg img-thumbnail align-center mt-3px" id="output">  <br>
                                                ...
                                                <input type="file" class="file" name="profile_pic" accept="image/*" onchange="loadFile(event)">
                                                <!-- <img src="" id="output" alt="" class="img-fluid"> -->
                                                <input type="submit" id="submit" name="upload">
                                                 ...
                                                 <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" data-provide="typeahead" id="the-basics" value="<?php echo $firstname;?>" name="f_name">
                                                        </div>
                                                        <div class="mb-3">
                                                        
                                                            <input type="text" class="form-control" data-provide="typeahead" id="the-basics" value="<?php echo $lastname;?>" name="l_name">
                                                        </div>
                                                        <div class="mb-3">
                                                        
                                                            <input type="text" class="form-control" data-provide="typeahead" id="the-basics" value="<?php echo $email;?>" name="email">
                                                        </div>
                                                        <div class="mb-3">
                                                        
                                                            <input type="text" class="form-control" data-provide="typeahead" id="the-basics" value="Old Password">
                                                        </div>
                                                        <div class="mb-3"> 
                                                        
                                                            <input type="text" class="form-control" data-provide="typeahead" id="the-basics" value="New Password" name="pwd"> <br>

                                                           
                                                           <center>
                                                           <input type="submit" name="update_data" class="btn btn-success btn-sm mb-5 align-items-center" value="Submit" >
                                                           </center>
                                                        </div>
                                                    </div> 

                    ...
                    <div class="container-fluid">
                        ...
                        ?>
                                                 ...
                                                 <div class="mb-3">
                                                          ...
                                                          <h1 class="text-dark font-15 text-bold">Add Category</h1>
                                                        </div>
                                                        <div class="mb-3"> 
                                                        
                                                            <input type="text" class="form-control" data-provide="typeahead" id="the-basics" placeholder="Add Category" name="cat_title"> <br>
                                                           <center>
                                                           <input type="submit" name="add_cat" class="btn btn-success btn-sm mb-5 align-items-center" value="Add Category">
                                                           </center>
                                                        </div>
                                                    </div> 
